...
export default async function SindicoAreasPage({
  searchParams,
}: {
  ...
  return (
    <div className="space-y-6">
      ...
      {isEditing ? (
        <AreaForm editingArea={editingArea} cancelHref="/sindico/areas" />
      ) : (
                    ...
                    <tr key={area.id} className="transition hover:bg-surface-container-low/50">
                      ...
                      <td className="py-4 text-right">
                        <div className="flex justify-end gap-2">
                          <Link
                            href={`/sindico/areas?edit=${area.id}`}
