      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        ...
        <div className="space-y-2 xl:col-span-3">
          <label className="text-sm font-semibold" htmlFor="senha">
            Senha {editingUser ? "nova" : "inicial"}
          </label>
          <input
            id="senha"
            name="senha"
            type="password"
            placeholder={editingUser ? "Preencha apenas para alterar a senha" : "Deixe em branco para gerar automaticamente"}
            className="w-full rounded-[14px] border border-outline-variant/40 bg-white px-4 py-3 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/15"
          />
          <p className="text-xs text-on-surface-variant">{getPasswordPolicyMessage()}</p>
        </div>
